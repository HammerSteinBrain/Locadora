...
CREATE TABLE `carro_reservado` (
  ...
  `tanque_de_combustivel` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `carro_reservado` VALUES (8,'usuario','Camaro','popular','2017','KYO-5005','Generic-for-this-trab','Prata','Usado','100.000','30 Litros restantes');
...
-- Dump completed on 2018-11-10 20:18:45
